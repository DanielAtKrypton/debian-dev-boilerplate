...
```bash
sudo apt update && yes | sudo apt upgrade && sudo apt install wget git curl && yes | sh -c "$(wget -O- https://github.com/DanielAtKrypton/debian-dev-boilerplate/raw/master/src/install_script.sh)"
```
